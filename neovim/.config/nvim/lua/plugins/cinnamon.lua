    ...
    config = function(_, opts)
        require("cinnamon").setup({
            ...
            smooth_scroll_config = {
                ...
                -- Lower values mean smoother animation but potentially more CPU usage.
                -- Default: 10
                interval = 5, -- Smoother animation
            ...
            delay_ms = 30, -- Slightly more responsive
            -- Maximum number of lines to render on the scrollbar.
            -- Useful for very large files to prevent performance issues.
